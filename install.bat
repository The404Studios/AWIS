...
dotnet add package Selenium.WebDriver.ChromeDriver --version 119.0.6045.10500
...
echo.
echo Installing Speech Recognition Libraries...
echo Note: System.Speech is built into .NET Framework
echo For .NET Core/5+, you may need alternative packages
...
echo.
echo Installing Neural Network Libraries...
dotnet add package CNTK.CPUOnly --version 2.7.0
rem Uncomment below for GPU support (requires CUDA)
rem dotnet add package CNTK.GPU --version 2.7.0

echo.
echo Installing NLP Libraries...
dotnet add package OpenNLP --version 1.6.0
dotnet add package SharpNLP --version 1.0.2592
dotnet add package Stanford.NLP.CoreNLP --version 4.5.5
